    ...
    'schemas' => [
        'default' => [
            'query' => [
                ...
                'getTransaction' => App\GraphQL\Query\TransactionQuery::class
            ],
            'mutation' => [
                ...
                'createTransaction' => App\GraphQL\Mutation\CreateTransactionMutation::class,
                'updateTransaction' => App\GraphQL\Mutation\UpdateTransactionMutation::class,
                'deleteTransaction' => App\GraphQL\Mutation\DeleteTransactionMutation::class
            ]
        ]
    ],
